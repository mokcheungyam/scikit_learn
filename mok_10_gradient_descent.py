...
"""
File Name: mok_10_gradient_descent.py
Author: mok
...
def gradient_descent_house_price():
    """使用梯度下降线性回归预测Boston房价"""
    ...
    # 4.线性回归预测
    # 初始化线性回归估计器
    sgdr = SGDRegressor()  # 梯度下降

    # 开始训练
    sgdr.fit(x_train, y_train.ravel())  # 使用.ravel()解决警告
    ...
    print('梯度下降下均方误差：', mean_squared_error(y_test_restore, y_predict_restore))

    # 5.保存模型
    joblib.dump(sgdr, "./tmp/sgdrtest2.pkl")


def main():
    gradient_descent_house_price()
