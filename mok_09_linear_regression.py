...
def linear_regression_house_price():
    """使用正规方程线性回归预测Boston房价"""
    ...
    print('正规方程下均方误差：', mean_squared_error(y_test_restore, y_predict_restore))

    # 5.保存模型
    joblib.dump(lr, "./tmp/lrtest1.pkl")
